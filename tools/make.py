...
def cmd_test_cov():
    ...
    _uv('pytest', str(TESTS_DIR), '-v', '--tb=short', '--cov=pytexmk', '--cov-report=term-missing',
        '-m', 'not slow and not requires_latex')
...
def cmd_dist():
    ...
    if platform.system() == 'Windows':
        ...
        c.print('[dim]PyInstaller exe build is Windows-only in this config; '
