...
LastEditTime : 2024-08-08 12:03:38 +0800
Github       : https://github.com/YanMing-lxb/
FilePath     : /PyTeXMK/src/pytexmk/language/lang_main.py
Description  : 
 -----------------------------------------------------------------------
'''
# -*- coding: utf-8 -*-
...
help_lang_en = {
    'description': "[i]LaTeX Auxiliary Compilation Program  ---- YanMing[/]",
    'epilog': 
        '''
...
main_lang_zh = {
    'pytexmk_version': 'PyTeXMK 版本: ',
    'pytexmk_start': 'PyTeXMK 开始运行...',
    'readme_openning': '正在打开 README 文件',
    'readme_path': 'README 本地路径: ',
    'readme_open_error': '打开 README 文件出错:',
    'extract_magic_comments': '提取魔法注释:',
    'magic_comment_program': '通过魔法注释设置程序为:',
    'magic_comment_outdir': '通过魔法注释设置输出目录:',
    'magic_comment_auxdir': '通过魔法注释设置辅助目录:',
}
main_lang_en = {
    'pytexmk_version': 'PyTeXMK Version: ',
    'pytexmk_start': 'PyTeXMK is starting...',
    'readme_openning': 'Opening README file',
    'readme_path': 'README local path: ',
    'readme_open_error': 'Error opening README file:',
    'extract_magic_comments': 'Extracting magic comments:',
    'magic_comment_program': 'Setting program via magic comment to:',
    'magic_comment_outdir': 'Setting output directory via magic comment to:',
    'magic_comment_auxdir': 'Setting auxiliary directory via magic comment to:',
}